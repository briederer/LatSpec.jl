...
**LatSpec.jl** is a package for performing spectroscopical analyses for [Lattice Field Theories](https://en.wikipedia.org/wiki/Lattice_field_theory). The package provides functions, recipes and suitable wrappers for all phases of the analysation process:
...
# **❗️ Warning: This package is in a very early stage ❗️**
  ...
  - So just be patient and add [Issues](https://github.com/briederer/LatSpec.jl/issues) or [Pull-Requests](https://github.com/briederer/LatSpec.jl/pulls) if you want something to be added.
...
#### Bernd Riederer ([@briederer](https://github.com/briederer))

[![Contact-me](https://img.shields.io/badge/@-Contact%20me-009DDC)](mailto:briederer.git@outlook.com?subject=[GitHub]%20LatSpec.jl)
...
[![Gitlab-briederer](https://img.shields.io/badge/GitLab-%40briederer-lightgrey?style=social&logo=gitlab)](https://gitlab.com/briederer)
